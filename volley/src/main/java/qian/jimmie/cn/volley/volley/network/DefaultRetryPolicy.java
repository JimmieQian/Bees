...
public class DefaultRetryPolicy implements RetryPolicy {
    ...
    public DefaultRetryPolicy(float backoffMultiplier) {
        this(DEFAULT_TIMEOUT_MS, DEFAULT_MAX_RETRIES, backoffMultiplier);
    }
     ...
     */
    @Override
    public void retry(GreeError error) throws GreeError {
        mCurrentRetryCount++;
